...
{
  list(
    list(dataset_name="Abalone",short_name="abalone",url="https://archive.ics.uci.edu/ml/machine-learning-databases/abalone/",
    ...
    list(dataset_name="Adult",short_name="adult",url="https://archive.ics.uci.edu/ml/machine-learning-databases/adult/",
    ...
    list(dataset_name="BlogFeedback",short_name="blog",url="https://archive.ics.uci.edu/ml/machine-learning-databases/00304/",
    ...
    list(dataset_name="Facebook comment volume",short_name="facebook",url="https://archive.ics.uci.edu/ml/machine-learning-databases/00363/",
    ...
    list(dataset_name = "Communities and Crime", short_name = "crime",
         ...
         file = "communities.data", zipfile = NULL, delim = "csv",
         ...
         default_target = "ViolentCrimesPerPop", null_char = "?", exclude_cols = c("state", "county", "community", "communityname", "fold"),
         default_task="regr"),
    list(dataset_name="3D Road Network (North Jutland, Denmark)",short_name="network3d",url="https://archive.ics.uci.edu/ml/machine-learning-databases/00246/",
         file="3D_spatial_network.txt",zipfile=NULL,delim="csv",col_names=FALSE,default_target=NULL,null_char=NULL,default_task="regr"),
    list(dataset_name="Airfoil Self-Noise",short_name="airfoil",url="https://archive.ics.uci.edu/ml/machine-learning-databases/00291/",
    ...
    list(dataset_name="Air Quality",short_name="airquality",url="https://archive.ics.uci.edu/ml/machine-learning-databases/00360/",
